...
namespace PizzaApp2.Controllers
{
    public class PizzasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PizzaName,PiizaCount,PizzaPrice")] Pizza pizza)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PizzaName,PiizaCount,PizzaPrice")] Pizza pizza)
        {
            if (id != pizza.Id)
            {
                return NotFound();
